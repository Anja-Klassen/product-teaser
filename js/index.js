...
const buyButtonTwo = document.querySelector('[data-js="buy-button"]');
//console.log(buyButtonTwo);
buyButtonTwo.addEventListener("click", () => {
  console.log(newName, price);
});

//This exercise includes an example of a product teaser for an online shop. Please
//append a second product teaser to the page with JavaScript based on the data given
...
//Add an event listener to the "buy" button of the second product teaser. When
//clicking the button, the product's name and price should be logged to the console.
